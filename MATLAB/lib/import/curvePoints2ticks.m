function [tickXY, endXY] = curvePoints2ticks(slider_struct,tick_rate)
...
tick_num = floor(slider_struct.pixel_length/tick_dist);
...
for tick = 1:tick_num
    ...
    tickXY(tick,:) = slider_points(slider_point_ind,:,section); % somehow few pixels off. This probably
